...
export default function KakaoChat() {
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-50 flex items-center gap-2 bg-[#FEE500] hover:bg-[#F5DB00] text-[#391B1B] font-bold text-sm px-4 py-3 rounded-full shadow-lg hover:shadow-xl transition-all hover:-translate-y-1 active:translate-y-0"
    >
